...
export default function Home() {
  return (
    <main>
      {/* About Me */}
      <div className='relative mx-auto flex min-h-[80vh] w-full max-w-7xl px-2'>
          ...
          <ul className='mx-auto grid max-w-2xl grid-cols-2 gap-4'>
            {data.projects.map((project) => {
              return (
                <li
                  key={project.title}
                  className='flex flex-col gap-1 rounded-md bg-background p-4 transition-opacity hover:cursor-pointer hover:opacity-70'
                >
